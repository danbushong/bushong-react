...
function Contact() {
    ...
    return (
        ...
        <div>
            ...
            <div className="card">
                <h1>Contact</h1>
                <p style={{textAlign: "center"}}>Send me an email @ BushongDan@gmail.com </p>
                <a style={{textAlign: "center"}} href="https://docs.google.com/document/d/e/2PACX-1vSvEhHQMiYBOu2hm4OF1_knBIyNyWweBRFcgWtniJ1v0LbXCxXGLNGgdIneRu4l7w/pub">Link To My Resume'</a>
